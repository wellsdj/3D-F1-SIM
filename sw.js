...
const CACHE='f1sim-loading-cancel-v8';
const SHELL=[
  './home-menu.css','./career-menu.css','./career-season.js','./retirement-route.js','./assets/career/pitlane-hero.png','./assets/career/driver-garage.png',
